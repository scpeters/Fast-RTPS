        ...
        ReaderProxyData* rdata)
{
    ...
    localpdata->m_properties.properties.push_back(EDPStaticProperty::toProperty("Reader", "ALIVE",
        ...
        const ParticipantProxyData& pdata)
{
    ...
    for (std::vector<std::pair<std::string, std::string> >::const_iterator pit =
            pdata.m_properties.properties.begin();
